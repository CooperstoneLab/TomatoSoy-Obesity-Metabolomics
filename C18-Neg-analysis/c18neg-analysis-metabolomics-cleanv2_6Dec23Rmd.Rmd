...
low_carot_tomato_effect <- anti_join(low_carot_tomato_effect,
                            red_sig_prepost_comp_clusters,
                            by = "mz_rt")
dim(low_carot_tomato_effect) # how many features are there now?
```
...
forcorr_pre_metabslog2_immuno_noOutlier <- forcorr_metabslog2_immuno_noOutlier %>%
  dplyr::select(Subject, Intervention, pre_post, 12:939) %>%
  filter(pre_post == "pre")
...
forcorr_diff_red_metabslog2_immuno_noOutlier <- forcorr_post_metabslog2_immuno_noOutlier[,4:931] - forcorr_pre_metabslog2_immuno_noOutlier[,4:931]
...
forcorr_diff_red_metabslog2_immuno_noOutlier <- forcorr_diff_red_metabslog2_immuno_noOutlier %>%
  ...
  filter(Intervention == "Red") %>%
  dplyr::select(Subject, Intervention, il_5, total_lyc, CD45ROpos_CD45RAneg_EMCD8, CD19posCD3neg_Bcells, CD27neg_IgDpos_naiveBcells, all_of(lyc_soy_effect$mz_rt))
