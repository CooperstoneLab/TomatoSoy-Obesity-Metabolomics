...
write_csv(higher_postYellow_noOutlier,
          "intervention-comp-sig-YELLOW-nooutliers-C18Pos-15Jun23.csv")
```
...
write_csv(red_sigfeatures_intervention_comp,
          "postRed-sigfeatures-interventioncomp-noOutliers-c18pos.csv")
...
write_csv(yellow_sigfeatures_intervention_comp,
          "postYellow-sigfeatures-interventioncomp-noOutliers-c18pos.csv")
```
