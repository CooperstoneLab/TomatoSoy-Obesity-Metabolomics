...
```{r}
metabdata <- read_csv(file = "Feature lists/FeatureList_C18Pos_noisotopefiltering_redo_24May23.csv",
...
MZ_RT_filt_PBremoved <- MZ_RT_filt_PB %>%
  ...
  select(-fold_higher_in_QC, -avg_height_QC, -avg_height_PB, -PBs)
...
write_csv(MZ_RT_filt_PBremoved,
          "Feature lists/C18Pos-Filtered-Data-24May23redo_3878features.csv")
```
