...
Daidzein is the only metabolite here that is significantly different between post-red vs. post-control.
...
write_csv(higher_postRed,
          "Feature lists/intervention-comp-sig-RED-C18Pos-newlog2fc-06-16Aug23.csv")

write_csv(higher_postYellow,
          "Feature lists/intervention-comp-sig-YELLOW-C18Pos-newlog2fc-06-16Aug23")
```
...
write_csv(higher_postRed_noOutlier,
          "Feature lists/intervention-comp-sig-RED-nooutliers-C18Pos-newlog2fc-06-16Aug23.csv")

write_csv(higher_postYellow_noOutlier,
          "Feature lists/intervention-comp-sig-YELLOW-nooutliers-C18Pos-newlog2fc-06-16Aug23.csv")
```
...
write_csv(red_sigfeatures_intervention_comp,
          "Feature lists/postRed-sigfeatures-interventioncomp-noOutliers-c18pos-newlog2fc-06-16Aug23.csv")
...
write_csv(yellow_sigfeatures_intervention_comp,
          "Feature lists/postYellow-sigfeatures-interventioncomp-noOutliers-c18pos-newlog2fc-06-16Aug23.csv")
```
...
write_csv(red_higher_post,
          "pre-post-sig-RED-C18Pos-15Jun23.csv")
```
...
write_csv(red_higher_post_noOutlier,
          "pre-post-sig-RED-nooutliers-C18Pos-15Jun23.csv")
```
...
write_csv(red_sigfeatures_pre_vs_post_comp,
          "Red-sigfeatures-PrevsPost-noOutliers-c18pos.csv")
...
write_csv(yellow_higher_post,
          "pre-post-sig-YELLOW-C18Pos-15Jun23.csv")
```
...
write_csv(yel_higher_post_noOutlier,
          "pre-post-sig-YELLOW-nooutliers-C18Pos-15Jun23.csv")
```
...
write_csv(yellow_sigfeatures_pre_vs_post_comp,
          "Yellow-sigfeatures-PrevsPost-noOutliers-c18pos.csv")
...
lyc_soy_effect <- anti_join(lyc_soy_effect,
                            yellow_sigfeatures_pre_vs_post_comp,
                            by = "mz_rt")
dim(lyc_soy_effect) # there actually is a change here.
```
