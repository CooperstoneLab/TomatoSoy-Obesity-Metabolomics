...
Let's first remove 6112 and see how this affects the data 

```{r}
subj6112_yellow <- meta_table_edited %>%
  filter(patient_id == 6112) %>%
  filter(intervention == "Yellow")

meta_table_edited_rm_outlier <- anti_join(meta_table_lyc_long, 
                                            subj6112_yellow)
...
cytokines_long <- meta_table_edited_rm_outlier[-c(26:82)] %>%
...
Comparing post-Red vs. post-Yellow
